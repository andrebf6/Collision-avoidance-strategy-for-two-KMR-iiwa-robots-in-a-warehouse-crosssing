        ...
        for kk in range(nw):
            ...
            if kk ==0:          # Collision detection activated
                while(1):
                    ...
                    if pr1[0]!=2000 and pr1[1]!=2000 and scan==True and (p%MS) == 0: # Position information has been published at least once and a new sensor reading has entred.
                ...
                while(1):
                    ...
                    if abs(yaw1[0]+1.57079633) > tol:
                        if (yaw1[0]+1.57079633)<0:
                            wz1=1
                        if (yaw1[0]+1.57079633)>0:
                            wz1=-1
                    elif abs(yaw1[0]+1.57079633) < tol:
                        wz1=0
