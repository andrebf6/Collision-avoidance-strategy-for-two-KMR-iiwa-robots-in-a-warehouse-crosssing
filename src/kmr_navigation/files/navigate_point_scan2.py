...
if __name__=="__main__":# Proteger parte del código. Assegura que el bloque solo se ejecutará si tu módulo es el programa principal.
    ...
    sub1 = node.create_subscription(String,'/robot2/chatter',listener_callback1, 10)
    ...
    sub2 = node.create_subscription(LaserScan, '/robot2/scan',listener_callback2, rclpy.qos.qos_profile_sensor_data)
        ...
        while(1): # while true
            ...
            while(1):
                ...
                if pr[0]!=2000 and pr[1]!=2000:
                    ...
                    salpha3=LA.norm(pb-pnb)/lb2; alpha3=math.asin(salpha3); print(alpha3*57.2957795)
                    salpha4=LA.norm(pb-pnc)/lc2; alpha4=math.asin(salpha4); print(alpha4*57.2957795)

                    blalpha3=4.71239-yaw[0]-theta+alpha3; print(blalpha3*57.2957795)
                    tt=blalpha3//6.28318530718; blalpha3=blalpha3-tt*6.28318530718; print(blalpha3*57.2957795)
                    if blalpha3 > 3.14159265359:
                        blalpha3=blalpha3-6.28318530718
                    if blalpha3 < -3.14159265359:
                        blalpha3=blalpha3+6.28318530718
                    print(blalpha3*57.2957795)

                    blalpha4=4.71239-yaw[0]-theta-alpha4; print(blalpha4*57.2957795)
                    uu=blalpha4//6.28318530718; blalpha4=blalpha4-uu*6.28318530718; print(blalpha4*57.2957795)
                    if blalpha4 > 3.14159265359:
                        blalpha4=blalpha4-6.28318530718
                    if blalpha4 < -3.14159265359:
                        blalpha4=blalpha4+6.28318530718
                    print(blalpha4*57.2957795)
                    ...
                    #if (p%15) == 0:
                    print(i1,i2)
                    print(blalpha3,angles[i1])
                    print(blalpha4,angles[i2])
                    print(i_readings)
